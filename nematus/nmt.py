...
def build_decoder_orig(tparams, options, y, ctx, init_state, dropout, x_mask=None, y_mask=None, sampling=False, pctx_=None, shared_vars=None):
    opt_ret = dict()
...
# RNN decoder (including embedding and feedforward layer before output)
def build_decoder_orig(tparams, options, y, ctx, init_state, dropout, x_mask=None, y_mask=None,
...
def build_model(tparams, options):
    ...
    logit, opt_ret, _ = build_decoder_orig(tparams, options, y, ctx, init_state, dropout, x_mask=x_mask, y_mask=y_mask,
                                      sampling=False)
